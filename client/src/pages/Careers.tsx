  ...
  const openPositions = [
    {
      ...
      location: "Remote",
      type: "Full-time",
      description: "Lead the development of cutting-edge AI models and systems. Work with our research team to bring breakthrough AI technologies to production."
    },
    {
      ...
      type: "Full-time", 
      description: "Drive innovation in machine learning algorithms and techniques. Publish research and contribute to the AI community while solving real-world problems."
    },
    {
      ...
      type: "Full-time",
      description: "Design intuitive user experiences for AI tools and platforms. Collaborate with engineers to make complex AI accessible to everyone."
    },
    {
      ...
      location: "Remote",
      type: "Full-time",
      description: "Build and maintain scalable infrastructure for AI applications. Ensure reliable deployment and monitoring of AI systems at scale."
    }
  ];
